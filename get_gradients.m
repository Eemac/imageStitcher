...
%       and vertical gradients.
    ...
    offset_left_horiz(radius+1:end-radius,radius+1:end-radius) = conv2(im2gray(imgaussfilt(left,sigma)),transpose(sobel),"same");
    ...
    offset_right_horiz(radius+1:end-radius,radius+1:end-radius) = conv2(im2gray(imgaussfilt(right,sigma)),transpose(sobel),"same");
